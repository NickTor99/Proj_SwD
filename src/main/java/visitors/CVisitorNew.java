...
public class CVisitorNew implements Visitor{
    ...
    public String visitProgramOp(AbstractSyntaxNode node){
    ...
    public String visitVarDeclOp(AbstractSyntaxNode node){
    ...
    public String visitFunOp(AbstractSyntaxNode node){
    ...
    public String visitParDeclOp(AbstractSyntaxNode node){
    ...
    public String visitBodyOp(AbstractSyntaxNode node){
    ...
    public void visitCallParamOp(AbstractSyntaxNode node){
    ...
    public void visitIfStatOp(AbstractSyntaxNode node){
    ...
    public void visitForStatOp(AbstractSyntaxNode node){
    ...
    public void visitWhileOp(AbstractSyntaxNode node){
    ...
    public void visitAssignOp(AbstractSyntaxNode node){
    ...
    public void visitReadOp(AbstractSyntaxNode node){
    ...
    public void visitWriteOp(AbstractSyntaxNode node){
    ...
    public void visitReturnStatOp(AbstractSyntaxNode node){
        codiceC += "return " + ((ReturnStatOp) node).getReturnExpr().accept(this) + ";\n";
    }

    public void visitBiExprNode(AbstractSyntaxNode node){
    ...
    public String visitConstExprNode(AbstractSyntaxNode node){
    ...
    public String visitUnExprNode(AbstractSyntaxNode node){
    ...
    public String visitIdExprNode(AbstractSyntaxNode node){
        String str = "";
    ...
    public void visitCallFunOp(AbstractSyntaxNode node){
